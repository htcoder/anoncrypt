...
<div id="container">
  ...
  <div id="SymE">
    <div class="center">
      <h1>Password based Encryption</h1>
      
   <h2>You encrypted message is given below </h2>
   ...
   <s:textarea name="Send" value="%{encrypted}" readonly="true"
     ...
     <a href="mailto:  ?Subject=Decrypt it on  anoncrypt &body= <s:property value="encrypted"/> "
><img src="img/mail.PNG" alt="Click to email the cipher"  /></a>
  ...
  <div id="side">
   <p>
    ...
    <p><a href="sym-encrypt.jsp" title="Symetrical Encryption" style="font-family: aclonica; font-style: normal; font-weight: 400; color: #70F802">Password Based Encryption</a></p>
    <p><a href="sym-decrypt.jsp" title="Password Based Decryption" style="font-family: aclonica; font-style: normal; font-weight: 400; color: #70F802">Password Based Decryption</a></p>
