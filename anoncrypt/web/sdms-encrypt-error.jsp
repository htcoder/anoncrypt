...
<div id="container">
  ...
  <div id="SymE">
    <div class="center">
      ...
      <center><a href="sym-decrypt.jsp"><img src="img/fuse.png" alt="Access Denied !!" " /></a></center>
      <h2> Please Try Again!!</h2>
	 <h3> Sorry!! We got Confused !!!</h3>
	  
	  <s:form action="encrypt">	
	<s:textfield label="Enter the Text"
             size="60"             
             maxlength="50"
             labelposition="top"
             required="true"
