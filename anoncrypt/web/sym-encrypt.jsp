...
<div id="container">
  ...
  <div id="SymE">
    <div class="center">
      ...
      <s:form name="send" action="Symencrypt">
      
	<s:textarea label="Enter the Text"
			cols="65" 
			rows="8" 
             size="60"  
   ...
   <s:password label="Enter the password"
             size="64"             
             maxlength="50"
	...
	<s:submit id="Encrypt it" value="Encrypt it" />
  ...
  <h2>Developed By: </h2>
   <center>
  <a href="https://www.facebook.com/rishabh.u "><img src="img/rishabh.png" alt="Rishabh Upadhyay"  /></a>

<a href="https://www.facebook.com/Mrrr.ajay "><img src="img/ajay.png" alt="Ajay Raj Singh"  /></a>

<a href="https://www.facebook.com/sauid "><img src="img/sauid.png" alt="Sauid Alam"  /></a>
 </center>
  </div>
  <p>&nbsp;</p>
</div>
