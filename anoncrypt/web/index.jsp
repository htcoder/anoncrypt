...
<head>
<meta charset="utf-8">
<title>Anoncrypt by HTCoders</title>
<style type="text/css">
#container {
	width: 1000px;
	height: 755px;
...
<div id="container">
  <div id="header"></div>
  <div id="SymE">
    <h1> <strong>About AnonCrypt</strong></h1>
    <p><strong>Anoncrypt is a service for securing text messages in an easy way. It could encrypt your message using strong encryption algorithms, so it will be more secure to send or store, than in plain text. Anyone who will get access to the encrypted message, will be unable to read original message without knowing your password.</strong></p>
    <div></div>
    <h3><strong>When to use:</strong></h3>
    <p><strong>Most of our communication channels can be easily accessed by third-parties, not only government and your internet provider, but even by your friends and family (if we're talking about social networks or your personal computer). Using Anoncrypt you could encrypt sensitive information with secure AES cipher, so nobody will get access to it without knowing original password.</strong></p>
  </div>
  <div id="side">
    <p>
