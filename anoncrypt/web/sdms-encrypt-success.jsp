...
<head>
<meta charset="utf-8">
<title>Self -Destructible Messging Service</title>
...
<div id="container">
  ...
  <div id="SymE">
    <div class="center">
      <h1>Self -Destructible Messging Service</h1>
      
      <h3> You may Send the following Cipher/Link  to your friend</h3>
      
      <s:textarea name="Send" value="%{encrypted}" readonly="true"
   					 cols="50" 
						rows="4" 
           				  />       
      <h3 style="text-align: center"><a href="http://localhost/anoncrypt/decrypt?decrypt=<s:property value="encrypted"/>" target="_blank">http://localhost/anoncrypt/decrypt?decrypt=<s:property value="encrypted"/> </a></h3>
       
       <a href="mailto:  ?Subject=Decrypt it on  anoncrypt &body= <s:property value="encrypted"/> OR  Visit http://localhost/anoncrypt/decrypt?decrypt=<s:property value="encrypted"/> "
><img src="img/mail.PNG" alt="Click to email the cipher"  /></a>
